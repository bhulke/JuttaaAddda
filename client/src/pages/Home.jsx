...
import bannerMobile from '../assets/bannerrmobile.png'
    ...
    <section className='bg-white'>
      ...
      <div className='container mx-auto rounded my-2 px-4'>
        ...
        <div className='items-center justify-center flex'>
          <div className='px-4 py-1 my-2 max-w-[300px] bg-gray-300 rounded flex items-center justify-center'>
            ...
            loadingCategory ? (
              new Array(12).fill(null).map((cat, index) => (
                <div key={index} className='bg-white rounded p-4 grid gap-2 shadow animate-pulse'>
                  <div className='bg-gray-300 rounded h-6'></div>
                  <div className='bg-gray-300 rounded h-4'></div>
                </div>
              ))
            ) : (
              categoryData.map((cate) => (
                <div key={cate._id} onClick={() => handleProductListPage(cate._id, cate.name)} className='flex flex-col items-center bg-gray-300 w-24 lg:w-38 p-2 hover:shadow-md cursor-pointer'>
