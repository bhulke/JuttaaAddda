    ...
    <section className='container  p-4 grid lg:grid-cols-2 lg:px-10 '>
        ...
        <div className='flex justify-center items-center gap-3 my-2'>
          {
            data.image.map((img, index) => {
              return (
                <div key={img + index + "point"} className={`bg-gray-200 w-3 h-3 lg:w-5 lg:h-5 rounded-full ${index === image && "bg-gray-300"}`}>
      ...
      <div className='p-4 lg:pl-7 text-base lg:text-lg'>
        ...
        <div className='flex items-center gap-2 lg:gap-4'>
          <div className='border border-gray-800 px-4 py-2 rounded bg-gray-50 w-fit'>
          ...
          {
            data.discount !== 0 && (
              <p className='text-gray-800 font-bold lg:text-2xl'>{data.discount}% <span className='text-base text-neutral-500'>Discount</span></p>
            )
          }
        </div>
        <div className='my-2'>
        ...
        <div className='mt-4'>
          ...
          />
          <button onClick={handleReviewSubmit} className='mt-2 px-4 py-2 bg-gray-800 text-white rounded hover:bg-gray-600'>
            Submit Review
          </button>
        </div>
