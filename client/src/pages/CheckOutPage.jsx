                ...
                <div className="w-full max-w-md bg-white py-4 px-2 rounded">
                    ...
                    <div className="w-full max-w-md flex flex-col gap-4 font-semibold">
                        <Link
                            ...
                            className="py-2 px-4 bg-gray-800 text-white hover:bg-gray-700 rounded flex items-center justify-center"
                        >
                        ...
                        <button
                            ...
                            className="py-2 px-4 border border-gray-800 hover:text-white text-gray-800 hover:bg-gray-800 rounded"
                        >
                            Cash on Delivery
                        </button>
                    </div>
