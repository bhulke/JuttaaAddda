        ...
        <div className="bg-gray-100 min-h-screen py-10 px-6 md:px-16">
            ...
            <div className="container mx-auto text-center md:text-left max-w-4xl">
                ...
                <div className="bg-white p-6 shadow-lg rounded-lg">
                    ...
                    <div className="mt-4">
                        <p className="text-lg text-gray-800"><strong>Email:</strong> juttaadda69@gmail.com</p>
                        <p className="text-lg text-gray-800"><strong>Phone:</strong> +977 9769696969</p>
                ...
                <div className="mt-8">
                    ...
                    <form className="bg-white p-6 shadow-lg rounded-lg mt-4" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="bg-gray-500 text-white px-6 py-2 rounded-lg text-lg hover:bg-gray-600">Send Message</button>
                    </form>
