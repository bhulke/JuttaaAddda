...
const EditSubCategory = ({url,close,data,fetchData}) => {
            ...
            <form className='my-4 grid gap-3' onSubmit={handleSubmit}>
                <div className='grid gap-1'>
                    ...
                    <input 
                        ...
                        type="text"
                        className='p-3 bg-blue-50 border border-blue-100 outline-none focus-within:border-gray-800 rounded'
                        />
                </div>
                <div className='grid gap-1'>
                    <p>Image</p>
                    <div className='flex flex-col lg:flex-row items-center gap-3'>
                        ...
                        <label htmlFor="uploadSubCategoryImage">
                            <div className={`
                                ${!subCategoryData.name ? "bg-gray-400" : "bg-gray-800 text-white hover:bg-gray-600 font-semibold"}
                ...
                <div className='grid gap-1'>
                    ...
                    <div className='border focus-within:border-gray-800 rounded'>
                    {/* display value */}
                            ...
                            subCategoryData.category.map((cat,index)=>{
                                return(
                                    <h1 key={cat._id+"selectedValue"} className='bg-blue-50 shadow-md px-1 py-2 flex items-center gap-2'>{cat.name}
                                        <div className='cursor-pointer hover:text-gray-800' onClick={()=>handleRemoveSelCat(cat._id)}>
                ...
                <button className={`py-2 font-semibold 
                        ${subCategoryData.name && subCategoryData.image && subCategoryData.category[0] ? "bg-gray-800 text-white hover:bg-gray-600" : "bg-gray-400"}
                    `}>
                    Update 
                </button>
