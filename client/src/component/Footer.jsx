  ...
  return (
    <footer className="bg-white py-10 shadow-[0px_-2px_8px_0px_rgba(0,_0,_0,_0.8)]">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div className="flex flex-col items-center">
          <div className='flex items-center'>
            <Link to={"/"}><img src={logo} alt="khaja" width={90} /></Link>
            <h2 className="text-2xl font-bold"></h2>
          </div>
          <p className="mt-2 text-gray-900 font-semibold">Your Sole Mate!</p>
        </div>
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-semibold">Quick Links</h3>
          <ul className="mt-2 space-y-2">
            <li><Link to="/aboutus" className="text-gray-900 hover:text-gray-500">About Jutta Adda</Link></li>
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex mt-3 space-x-4">
            ...
            <a href="#" className="text-gray-900 hover:text-gray-500 text-2xl">
              <FaInstagram />
            </a>
      ...
      <div className="text-center text-gray-700 mt-8 border-t border-gray-700 pt-4">
        &copy; 2025 Jutta Adda. All rights reserved.
      </div>
    </footer>
  )
}
