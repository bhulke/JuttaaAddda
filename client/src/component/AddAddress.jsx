        ...
        <section className='bg-gray-900/70 fixed top-0 right-0 left-0 bottom-0 z-50 h-[100vh] overflow-auto'>
            <div className='bg-white p-4 w-full max-w-lg mt-10 mx-auto rounded'>
                <div className='flex items-center justify-between'>
                    ...
                    <button onClick={close} className='hover:text-gray-800'><IoMdCloseCircle size={25} /></button>
                </div>
                <form className='mt-4 grid gap-4' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type='submit' className='bg-gray-800 w-full text-white font-semibold py-2 mt-4 hover:bg-gray-600 rounded'>Submit</button>
                </form>
            </div>
        </section>
    )
