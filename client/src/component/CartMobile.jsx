        ...
        <>
            {
                cartItem[0] && (
                    <div className='sticky bottom-4 px-2'>
                        <div className='bg-gray-800 px-2 py-1 rounded text-white text-sm flex items-center lg:hidden justify-between gap-3'>
                            <div className='flex items-center gap-2'>
                                <div className='p-2 bg-gray-700 rounded w-fit '>
                                    <BsCart4 size={20} />
                                </div>
                                <div className=''>
                                    <p>{totalQty} Items</p>
