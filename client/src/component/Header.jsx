                            ...
                            <div className='hidden lg:flex items-center gap-10'>
                                {
                                    user?._id ? (
                                        ...
                                        <button onClick={redirectToLoginPage} className='text-lg px-3 hover:text-[#787272] '>Login</button>
                                    )
                                }
                                <button onClick={()=>setOpenCart(true)} className='flex items-center gap-2 bg-[#787272] hover:bg-[#3d3c3c] py-2 px-3 rounded text-white'>
