    ...
    <section className='bg-neutral-900/50 fixed top-0 right-0 left-0 bottom-0 z-50'>
      <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
        ...
        <div className='max-h-[calc(100vh-135px)] h-full lg:min-h-[80vh] min-h-[77vh] bg-blue-50 p-2 flex flex-col gap-4'>
          {
            cartItem[0] ? (
              ...
              <div className='bg-white flex flex-col items-center justify-center'>
                ...
                <Link onClick={close} to={"/"} className='bg-gray-800 text-white px-2 py-1 rounded m-2 hover:bg-gray-600 font-semibold'>Shop Now</Link>
              </div>
            )
          }
        </div>
        {
          cartItem[0] && (
            <div className='p-2'>
              <div className='bg-gray-800 text-white p-2 py-4 sticky bottom-3 font-bold lg:text-lg text-base rounded flex gap-4 items-center justify-between'>
                <div>
